...
この資料は、次の代が前の代から直接説明を受けなくても、nicotwiの管理・変更・引き継ぎを行えるようにするための資料です。
初めて引き継ぐ場合は、まず[代替わりチェックリスト](#代替わりチェックリスト自分で管理を始める時にやること)を上から順番に進めてください。初めて触る時は、[代替わりチェックリスト](#代替わりチェックリスト自分で管理を始める時にやること)を上から順番に進めれば準備が整います。
